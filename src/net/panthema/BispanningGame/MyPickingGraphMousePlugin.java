...
public class MyPickingGraphMousePlugin<V, E> extends AbstractGraphMousePlugin
        ...
        if(pickSupport != null && pickedVertexState != null) {
            ...
            if(e.getModifiers() == modifiers) {
                ...
                if(vertex != null) {
                    ...
                    Point2D gp = vv.getRenderContext().getMultiLayerTransformer().inverseTransform(Layer.VIEW, ip);
    ...
    public void mouseDragged(MouseEvent e) {
        if(locked == false) {
            ...
            if(vertex != null) {
                Point p = e.getPoint();
                Point2D graphPoint = vv.getRenderContext().getMultiLayerTransformer().inverseTransform(Layer.VIEW, p);
                Point2D graphDown = vv.getRenderContext().getMultiLayerTransformer().inverseTransform(Layer.VIEW, down);
                Layout<V,E> layout = vv.getGraphLayout();
